...
public class jClientC1 {
    ...
    public static void main(String[] args) {
        ...
        // create client
        jClientC1 client = new jClientC1();
    ...
    static void print_usage() {
             System.out.println("Usage: java jClientC1 [--robname <robname>] [--pos <pos>] [--host <hostname>[:<port>]] [--map <map_filename>]");
    }
